...
private:
	...
	static constexpr double DISTANCE_FROM_ALLIANCE_WALL_TO_SIDE_GEAR = (116.0 - ROBOT_WITH_BUMPERS_LENGTH);
	...
	static constexpr double ANGLE_TO_TURN_AFTER_DRIVING_OFF_RIGHT_ALLIANCE_WALL = 60.0;
	//  Close Shot Left
