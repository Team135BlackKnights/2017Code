...
void ReadUltrasonicSensorValue::Execute() {
	...
	frc::SmartDashboard::PutNumber("Gear Ultrasonic Sensor Value IN: ", gearUltrasonicSensorValue);
	//std::cout << "Gear Ultrasonic Sensor Value: " << gearUltrasonicSensorValue << std::endl;
}
