...
private:
	...
	static const int MIDDLE_GEAR_SHOOT_RIGHT_AUTONOMUS_HOOD_ENCODER_VALUE = 15000;
	static const int MIDDLE_GEAR_SHOOT_LEFT_AUTONOMOUS_HOOD_ENCODER_VALUE = 15000;
